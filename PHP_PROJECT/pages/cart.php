...
<body>
            ...
            <div class="cart-layout">
                ...
                <div class="order-summary">
                    ...
                    <div class="summary-row">
                        <span>Shipping</span><span><?php echo $shipping == 0 ? 'FREE' : '₹' . number_format($shipping); ?></span>
                    </div>
                    <div class="summary-row total"><span>Total</span><span>₹<?php echo number_format($total); ?></span>
                    </div>
    ...
    <script>
        async function handleCartAction(productId, action) {
            try {
                // Send the productId and the action ('increase', 'decrease', 'remove')
                const response = await fetch('/PHP_PROJECT/controllers/update-cart.php', {
                    method: 'POST',
                    headers: {
                    ...
                    body: JSON.stringify({
                        ...
                        action: action // Sending the action command
                    })
                });
                ...
                if (result.success) {
                    // Action was successful, simply reload the page to see changes
