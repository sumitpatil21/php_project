...
try {
    ...
    if ($e->getCode() === 1049) { 
        try {
            ...
            $pdo->exec("CREATE TABLE IF NOT EXISTS `orders` ( `id` INT AUTO_INCREMENT PRIMARY KEY ) ENGINE=InnoDB;");
            $pdo->exec("CREATE TABLE IF NOT EXISTS `order_items` ( `id` INT AUTO_INCREMENT PRIMARY KEY ) ENGINE=InnoDB;");
