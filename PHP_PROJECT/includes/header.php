            ...
            <div class="container">
                <div class="main-bar-content">
                    ...
                    <div class="account-links">
                        <?php if ($isLoggedIn): ?>
                            <div class="user-dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <a href="/PHP_PROJECT/pages/orders.php">
                        ...
                        <a href="/PHP_PROJECT/pages/wishlist.php" class="account-link">
            ...
            <div class="container">
                <div class="bottom-bar-content">
                    <nav class="main-navigation">
                        ...
                        <a href="/PHP_PROJECT/pages/eyeglasses.php?page=" class="nav-link">STORE LOCATOR</a>
                    </nav>
